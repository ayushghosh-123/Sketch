...
function ProjectWorkspaceInner({ projectId }: { projectId: string }) {
  ...
  if (loading) {
    return (
      <div className="flex-1 flex items-center justify-center p-12 bg-[#000000] text-white">
  ...
  if (!project) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center p-12 text-center bg-[#000000] text-white">
        ...
        <Link href="/projects">
          <Button size="sm" variant="outline" className="border-white/10 bg-[#111111] text-white hover:bg-[#18181b] font-mono text-xs">
            Back to Registry
          </Button>
        </Link>
      </div>
  ...
  return (
    <div className="flex flex-col flex-1 h-[calc(100vh-68px)] overflow-hidden bg-[#000000] text-white">
      {/* Project Workspace Command Bar */}
      <div className="flex items-center justify-between px-4 sm:px-6 py-2.5 border-b border-white/10 bg-[#000000]/90 backdrop-blur-md shrink-0">
        <div className="flex items-center gap-3">
          <Link
            href="/projects"
            className="text-[#71717a] hover:text-white p-1.5 rounded-lg hover:bg-[#18181b] transition-colors border border-transparent hover:border-white/10"
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-[10px] px-2 py-0.5 rounded-md bg-[#18181b] border border-white/10 text-[#f97316] uppercase font-semibold">
        ...
        <div className="flex items-center gap-1">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-auto">
            <TabsList className="h-8 bg-[#111111] border border-white/10 p-0.5 rounded-lg">
              <TabsTrigger value="architecture" className="text-[11px] font-mono gap-1.5 px-3 rounded-md data-[state=active]:bg-[#18181b] data-[state=active]:text-[#f97316]">
                <Network className="h-3.5 w-3.5 text-[#f97316]" />
                <span className="hidden sm:inline">STUDIO</span>
              </TabsTrigger>
              <TabsTrigger value="overview" className="text-[11px] font-mono gap-1.5 px-3 rounded-md data-[state=active]:bg-[#18181b] data-[state=active]:text-white">
                <Layers className="h-3.5 w-3.5 text-indigo-400" />
                <span className="hidden sm:inline">SPECS</span>
              </TabsTrigger>
              <TabsTrigger value="documents" className="text-[11px] font-mono gap-1.5 px-3 rounded-md data-[state=active]:bg-[#18181b] data-[state=active]:text-[#f97316]">
                <FileText className="h-3.5 w-3.5 text-[#f97316]" />
                <span className="hidden sm:inline">CORPUS & RAG</span>
              </TabsTrigger>
              <TabsTrigger value="chat" className="text-[11px] font-mono gap-1.5 px-3 rounded-md data-[state=active]:bg-[#18181b] data-[state=active]:text-white">
                <MessageSquare className="h-3.5 w-3.5 text-[#10b981]" />
                <span className="hidden sm:inline">AI ARCHITECT</span>
              </TabsTrigger>
              <TabsTrigger value="impact" className="text-[11px] font-mono gap-1.5 px-3 rounded-md data-[state=active]:bg-[#18181b] data-[state=active]:text-white">
                <Activity className="h-3.5 w-3.5 text-amber-400" />
                <span className="hidden sm:inline">IMPACT</span>
              </TabsTrigger>
              <TabsTrigger value="versions" className="text-[11px] font-mono gap-1.5 px-3 rounded-md data-[state=active]:bg-[#18181b] data-[state=active]:text-white">
                <GitFork className="h-3.5 w-3.5 text-rose-400" />
                <span className="hidden sm:inline">VERSIONS</span>
              </TabsTrigger>
              <TabsTrigger value="settings" className="text-[11px] font-mono gap-1.5 px-3 rounded-md data-[state=active]:bg-[#18181b] data-[state=active]:text-white">
        ...
        {activeTab === "overview" && (
          <div className="max-w-6xl mx-auto p-4 sm:p-6 space-y-6">
            <div className="flex items-center justify-between pb-3 border-b border-white/10">
              ...
              <span className="font-mono text-xs px-2.5 py-1 rounded-md bg-[#111111] border border-white/10 text-[#a1a1aa]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl border border-white/10 bg-[#111111]">
                <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#f97316] mb-2 pb-2 border-b border-white/10">
              ...
              <div className="p-4 rounded-xl border border-white/10 bg-[#111111]">
                <div className="flex items-center gap-2 text-xs font-mono font-bold text-indigo-400 mb-2 pb-2 border-b border-white/10">
              ...
              <div className="p-4 rounded-xl border border-white/10 bg-[#111111]">
                <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#10b981] mb-2 pb-2 border-b border-white/10">
              ...
              <div className="p-4 rounded-xl border border-white/10 bg-[#111111]">
                <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#f59e0b] mb-2 pb-2 border-b border-white/10">
              ...
              <div className="p-4 rounded-xl border border-white/10 bg-[#111111] md:col-span-2">
                <div className="flex items-center gap-2 text-xs font-mono font-bold text-rose-400 mb-2 pb-2 border-b border-white/10">
