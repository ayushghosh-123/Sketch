...
export default function SSOCallbackPage() {
  return (
    <div className="flex-1 w-full bg-[#FAFAFA] flex flex-col items-center justify-center min-h-[70vh] text-[#0D0D0D]">
      <div className="flex flex-col items-center gap-3">
        {/* Minimal AGENTARCHITECT brand glyph */}
